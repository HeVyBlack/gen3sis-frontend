      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div
            id="r_social_help"
            class="form-text error"
            v-for="error in v$.account.r_social.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
        ...
        <div class="col">
          ...
          <div
            id="nit_help"
            class="form-text error"
            v-for="error in v$.account.nit.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div
            id="tel_help"
            class="form-text error"
            v-for="error in v$.account.tel.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
        ...
        <div class="col">
          ...
          <div
            id="ext_help"
            class="form-text error"
            v-for="error in v$.account.ext.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div
            id="name_help"
            class="form-text error"
            v-for="error in v$.cont.name.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
        ...
        <div class="col">
          ...
          <div
            id="last_name_help"
            class="form-text error"
            v-for="error in v$.cont.last_name.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div
            id="email_help"
            class="form-text error"
            v-for="error in v$.cont.email.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
        ...
        <div class="col">
          ...
          <div
            id="tel_help"
            class="form-text error"
            v-for="error in v$.cont.tel.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
      ...
      <div class="row justify-content-center">
        <div class="col-6">
          ...
          <div
            id="pos_help"
            class="form-text error"
            v-for="error in v$.cont.pos.$errors"
            :key="error.$uid"
          >
            {{ error.$message }}
          </div>
