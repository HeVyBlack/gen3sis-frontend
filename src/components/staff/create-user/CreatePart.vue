  ...
  <div class="container px-5">
    ...
    <form v-on:submit.prevent id="form">
      <div class="row mb-3">
        <!--email-->
        <div class="col">
          <label for="part_email" class="form-label"
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            <div
              id="tel_help"
              class="form-text error"
              v-for="error in v$.info.account.activity.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div
              id="r_social_help"
              class="form-text error"
              v-for="error in v$.info.account.r_social.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              v-model="formData.info.account.r_social"
            />
          </div>
          <br />
          <!--nit-->
          <div class="col">
            ...
            <div
              id="nit_help"
              class="form-text error"
              v-for="error in v$.info.account.nit.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              id="nit"
              aria-describedby="nit_help"
              v-model="formData.info.account.nit"
            />
          </div>
        </div>
        <br />
        <div class="row">
          ...
          <div class="col">
            ...
            <div
              id="tel_help"
              class="form-text error"
              v-for="error in v$.info.account.tel.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <div id="tel_help" class="form-text error">
              {{ countryCodeError }}
            </div>
            <div class="row tel-input">
              <div class="col-3 p-0">
                <select
                  class="form-select"
                  aria-label="Default select example"
              ...
              <div class="col p-0">
                <input
                  ...
                  v-model="formData.info.account.tel"
                />
              </div>
            </div>
          </div>
          ...
          <div class="col">
            ...
            <div
              id="ext_help"
              class="form-text error"
              v-for="error in v$.info.account.ext.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              v-model="formData.info.account.ext"
            />
          </div>
        </div>
        <br />
        ...
        <div class="row justify-content-center">
          <div class="col-6">
            ...
            <input
              ...
              v-model="formData.info.account.web_page"
            />
          </div>
        </div>
        <br />
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div
              id="name_help"
              class="form-text error"
              v-for="error in v$.info.cont.name.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              v-model="formData.info.cont.name"
            />
          </div>
          <!--last_name-->
          <div class="col">
            ...
            <div
              id="last_name_help"
              class="form-text error"
              v-for="error in v$.info.cont.last_name.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              v-model="formData.info.cont.last_name"
            />
          </div>
        </div>
        <br />
        <div class="row">
          ...
          <div class="col">
            ...
            <div
              id="email_help"
              class="form-text error"
              v-for="error in v$.info.cont.email.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              id="email"
              aria-describedby="email_help"
              v-model="formData.info.cont.email"
            />
          </div>
          <br />
          <!--tel-->
          <div class="col">
            <label for="cont_tel" class="form-label"
              ><strong>Teléfono de la persona de contacto</strong></label
            >
            <div
              id="cont_tel_help"
              class="form-text error"
              v-for="error in v$.info.cont.tel.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              class="form-control"
              id="cont_tel"
              aria-describedby="cont_tel_help"
              v-model="formData.info.cont.tel"
            />
          </div>
        </div>
        <br />
        ...
        <div class="row justify-content-center">
          <div class="col-6">
            <label for="pos" class="form-label"
              ><strong
                >Área de trabajo en la empresa de la persona de contacto</strong
              ></label
            >
            <div
              id="pos_help"
              class="form-text error"
              v-for="error in v$.info.cont.pos.$errors"
              :key="error.$uid"
            >
              {{ error.$message }}
            </div>
            <input
              ...
              v-model="formData.info.cont.pos"
            />
          </div>
        </div>
      </template>
      ...
      >
        <div class="container p-3">
          ...
          <template v-if="checkbox">
            <button class="btn btn-dark mt-3" @click="submitForm">
              Enviar
            </button>
          </template>
        </div>
...
const countryCode = ref("0");
const countryCodeError = ref(null);
...
const rules = {
  ...
  password: {
    ...
    maxLength: helpers.withMessage(
      "La contraseña debe contener menos de 8 caracteres",
      minLength(8)
    ),
  },
  info: {
...
const submitForm = async () => {
  ...
  sample_form.email = formData.value.email;
  sample_form.password = formData.value.password;
  for (const i in formData.value.info.account) {
    sample_form.info.account[i] = formData.value.info.account[i];
  }
  for (const i in formData.value.info.cont) {
    sample_form.info.cont[i] = formData.value.info.cont[i];
  }
...
const postForm = async () => {
  if (!fillForm.value) delete sample_form.info;
  await axios
    .post("staff/create-new-part", sample_form)
    .then(async (res) => {
